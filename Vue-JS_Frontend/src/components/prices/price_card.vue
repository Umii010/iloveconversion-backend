    ...
    <div class="card card--purple">
      <div class="card__outer">
        <div class="card__inner">
          ...
          <p class="price"><span class="price price--number"><span class="price price--dolar">$</span>29</span></p>
    ...
    <div class="card card--red active">
      <div class="card__outer">
        <div class="card__inner">
          ...
          <p class="price"><span class="price price--number"><span class="price price--dolar">$</span>49</span></p>
    ...
    <div class="card card--green">
      <div class="card__outer">
        <div class="card__inner">
          ...
          <p class="price"><span class="price price--number"><span class="price price--dolar">$</span>89</span></p>
...
.card--purple.active .card__outer {
  background: #6824d6;
  box-shadow: 5px 18px 13px rgba(104, 36, 214, 0.4);
}
.card--purple:hover a,
.card--purple.active a {
  color: #fff;
}
...
.card--red.active .card__outer {
  background: #fe3258;
  box-shadow: 5px 18px 13px rgba(254, 50, 88, 0.4);
}
.card--red:hover a,
.card--red.active a {
  color: #fff;
...
.card--green.active .card__outer {
  background: #4ccda7;
  box-shadow: 5px 18px 13px rgba(76, 205, 167, 0.4);
}
.card--green:hover a,
.card--green.active a {
  color: #fff;
